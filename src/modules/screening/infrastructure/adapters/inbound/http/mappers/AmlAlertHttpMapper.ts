...
export function toAmlAlertResponse(alert: AmlAlert): AmlAlertResponseDto {
  return {
    ...
    entidadSospechosa: alert.entidadSospechosa,
    confianza: alert.confianza,
    fuenteDeteccion: alert.fuenteDeteccion,
    estado: alert.estado,
    severidad: alert.severidad,
    matchedEntry: {
      entryId: String(alert.matchedEntry.entryId),
      watchlistId: String(alert.matchedEntry.watchlistId),
      nombre: alert.matchedEntry.nombre,
      documento: alert.matchedEntry.documento,
      nivelRiesgo: alert.matchedEntry.nivelRiesgo,
