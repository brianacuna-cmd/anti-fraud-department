...
/**
 * Reads a single SAR report. Tenant-scoped, mirrors `GetCaseReport.ts`: a
 * missing one is a 404, one from another org is a 403 (never leaked as
 * "not found"). No role check — reading a report is not an act of
 * authority, unlike drafting/approving/filing it.
 */
